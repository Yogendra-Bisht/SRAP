...
const rooms = [
    ...
    { id: 5, name: "Co-living Space", price: "₹7,200", image: "https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?w=500" },
];
                ...
                >
                    {[...rooms, ...rooms].map((room, index) => (
                        <div key={index} className=" min-w-[300px] h-[400px] rounded-3xl overflow-hidden relative group shadow-xl">
                            <Image src={room.image} alt={room.name} fill sizes="(max-width: 768px) 100vw, 300px" className="object-cover transition-transform duration-500 group-hover:scale-110" />
